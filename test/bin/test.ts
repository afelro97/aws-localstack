...
export class MyStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    const dbInstance = new rds.DatabaseInstance(this, 'MyDBInstance', {
      ...
      credentials: rds.Credentials.fromPassword('user', cdk.SecretValue.plainText('pass')),
      vpc,
    ...
    const myLambdaFunction = new lambda.Function(this, 'MyLambdaFunction', {
      ...
      role: iam.Role.fromRoleArn(this, 'LambdaExecutionRole', 'arn:aws:iam::488266856645:role/LambdaExecutionRole'),
